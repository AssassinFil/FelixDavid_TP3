	...
	public function add() {
		if ($this->request->is('post')) {
			...
			if ($this->Client->save($this->request->data)) {
				$this->Session->setFlash(__('The client has been saved.'), array ('class' => 'alert alert-success'));
				return $this->redirect(array('action' => 'index'));
			} else {
				$this->Session->setFlash(__('The client could not be saved. Please, try again.'), array ('class' => 'alert alert-danger'));
			}
		}
		$policies = $this->Client->Policy->find('list');
